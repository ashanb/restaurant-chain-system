...
public partial class BaseRestaurant_RestaTester : System.Web.UI.Page
{
 ...
 myText.Text = k;*/
  ...
  //  <asp:HyperLink ID='HyperLink1'  class='button' title='Login Now' runat='server' NavigateUrl='../LoginA.aspx'>Login Now!</asp:HyperLink>       
//           
}
        }
        catch
