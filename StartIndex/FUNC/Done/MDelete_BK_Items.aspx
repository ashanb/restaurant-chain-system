<%@ Page Title="" Language="C#" MasterPageFile="~/FUNC/Done/MasterPageProp.master" AutoEventWireup="true" CodeFile="MDelete_BK_Items.aspx.cs" Inherits="Delete_BK_Items" %>
...
<div style="width: 784px; height: 715px; color: #000000; font-size: large;">
    ...
    <asp:Panel ID="Panel1" runat="server" BorderStyle="Groove">
            ...
            GroupingText="Delete BK Item" Font-Size="Medium">
