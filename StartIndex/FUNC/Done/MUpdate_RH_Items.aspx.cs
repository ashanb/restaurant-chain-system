...
public partial class UpdateRH_Items : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Master.HeadingMessage = "Update Items from the Rest House Stock";
    }
    protected void Add(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            DataSet dataset = ProductManager.currentQV(tb1, "RH");
            int Q_AV = int.Parse(dataset.Tables["Base_current_qv"].Rows[0]["Q_AV"].ToString());

            tb2 = tb2 + Q_AV;


            ProductManager.updateItems(tb1, tb2,tb3,tb4 ,"RH");
