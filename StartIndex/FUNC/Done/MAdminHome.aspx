<%@ Page Title="" Language="C#" MasterPageFile="~/FUNC/Done/MasterPageProp.master" AutoEventWireup="true" CodeFile="MAdminHome.aspx.cs" Inherits="MHomePage" %>
    ...
    <div style="width: 784px; height: auto; background-color: #FFFFFF;">
        ...
        <table style="width:100%;">
            <tr>
                ...
                <div style="background-color: #C0C0C0">Welcome to the Server Administrator</div>
