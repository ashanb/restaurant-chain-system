...
public partial class RTSalesDes : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Master.HeadingMessage = "Restaurant :Adding Items to the Bill";
    ...
    protected void Add(object sender, EventArgs e)
    {
        ...
        try
        {
            DataSet dataset = ProductManager.ShowBase_ItemnoisCorrectRT(ItemNoLabel.Text, UnitPriceTextBox.Text);

            String tester = dataset.Tables["Base_itemnoisCorrectRT"].Rows[0]["item_no"].ToString();
            count = 1;
        }
...
/////
        ProductManager.AddRTSale_Des(sales_id,ItemNoLabel.Text,int.Parse(QuantityTextBox.Text),int.Parse(UnitPriceTextBox.Text) * int.Parse(QuantityTextBox.Text));
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        String item_name =DropDownList1.SelectedItem.ToString();
          DataSet dataset =ProductManager.ShowBase_RT_NameitemJoin(item_name);
         String item_no = dataset.Tables["Base_RT_NameItemJoin"].Rows[0]["item_no"].ToString();
        ItemNoLabel.Text = item_no;

        DataSet dataset2 =ProductManager.ShowBase_RT_items(item_no);
      UnitPriceTextBox.Text = dataset2.Tables["Base_RT_items"].Rows[0]["unit_price"].ToString();
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
      ...
      //  SaleNameLabel.Text = total + "";
        ...
        try
        {
            ...
            Response.Redirect("MAdd_RT_Sales_Report.aspx?sales_id=" + sales_id);
        }
        catch
        {
