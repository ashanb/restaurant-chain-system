<%@ Page Title="" Language="C#" MasterPageFile="~/FUNC/Done/MasterPageProp.master" AutoEventWireup="true" CodeFile="MAdd_User_Detail.aspx.cs" Inherits="FUNC_OK_Default" %>
...
<div style="width: 784px; height: 461px; color: #000000; font-size: large;">
         ...
         <table border="strong" style="margin-top: 0px">
        <tr>
            <td style="width: 163px">
                <asp:Label ID="Label2" runat="server" Text="National ID" ForeColor="Black"></asp:Label>
            </td>
            <td >
                <asp:TextBox ID="NIDTextBox" runat="server" Height="32px" Width="318px"></asp:TextBox>
            </td>
            <td class="style6" >
