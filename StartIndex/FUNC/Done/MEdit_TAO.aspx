<%@ Page Title="" Language="C#" MasterPageFile="~/FUNC/Done/MasterPageProp.master" AutoEventWireup="true" CodeFile="MEdit_TAO.aspx.cs" Inherits="ViewUsers" %>
        ...
        <tr>
            ...
            <td class="style3" colspan="3" >
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                    ...
                    UpdateMethod="update_Shenali_StocksTAO">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="TAO" Name="loc" Type="String" />
                    </SelectParameters>
                    <UpdateParameters>
