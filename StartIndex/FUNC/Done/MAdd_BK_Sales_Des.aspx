<%@ Page Title="" Language="C#" MasterPageFile="~/FUNC/Done/MasterPageProp.master" AutoEventWireup="true" CodeFile="MAdd_BK_Sales_Des.aspx.cs" Inherits="FUNC_OK_Default" %>
...
&nbsp;</td>
        ...
        <tr>
            ...
            <td class="style3">
                <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" 
                    SelectMethod="ShowBase_Bk_itemNameJoin" TypeName="ProductManager">
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" 
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="sales_id,sales_item_no" 
                    DataNavigateUrlFormatString="MAdd_BK_Sales_Des.aspx?sales_id={0}&sales_item_no={1}" 
                    Text="Delete" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        DeleteMethod="Delete_BK_sales_des" SelectMethod="ShowBase_BKSales_des" 
