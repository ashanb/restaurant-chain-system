<%@ Page Title="" Language="C#" MasterPageFile="~/FUNC/Done/MasterPageProp.master" AutoEventWireup="true" CodeFile="MViewRH_Records.aspx.cs" Inherits="RHRecords" %>
        ...
        <tr>
            ...
            <td >
                <asp:DropDownList ID="RTypeDropDownList" runat="server" Height="32px" 
                    Width="200px">
                     <asp:ListItem Text="Total Number of Rooms Allocated" />
                          <asp:ListItem Text="Total Number of Bills Canceled " />
                           <asp:ListItem Text="Total Bill Amount" />            
