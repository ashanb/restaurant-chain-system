<%@ Page Title="" Language="C#" MasterPageFile="~/FUNC/Done/MasterPageProp.master" AutoEventWireup="true" CodeFile="MAddGalleryImage.aspx.cs" Inherits="FUNC_Done_MAddGalleryImage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" Runat="Server">
    ...
    <table border="strong" bgcolor="#D1A476">
        ...
        <tr >
            ...
            <td>
                <asp:FileUpload ID="FileUpload1" runat="server" BackColor="#E1C5A8"
