<%@ Page Title="" Language="C#" MasterPageFile="~/FUNC/Done/MasterPageProp.master" AutoEventWireup="true" CodeFile="MDelete_RT_Items.aspx.cs" Inherits="Delete_RT_Items" %>
...
<div style="width: 784px; height: 715px; color: #000000; font-size: large;">
    ...
    <asp:Panel ID="Panel1" runat="server" BorderStyle="Groove">
            ...
            GroupingText="Delete Restaurant Item" Font-Size="Medium">
            ...
            <tr>
                <td>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT &quot;ITEM_NO&quot; FROM &quot;BASE_RT_ITEMS&quot;">
                    </asp:SqlDataSource>
                </td>
                <td>
                    &nbsp;
