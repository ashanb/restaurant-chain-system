<%@ Page Title="" Language="C#" MasterPageFile="~/FUNC/Done/MasterPageProp.master" AutoEventWireup="true" CodeFile="InViewInRead.aspx.cs" Inherits="InRead" %>
 ...
 <div id="menu22">
        ...
        <div id="menu23">
             ...
             <ul>
               ...
               <li><a class="active" href="InViewInRead.aspx">View Read</a></li>
    ...
    <asp:Panel ID="Panel1" runat="server" BorderStyle="Groove">
        <table style="width: 100%;">
            <tr>
                <td colspan="3" class="style5">
                  <p style="font-weight: bolder; color: #000000; font-size: large; font-family: 'Courier New', Courier, monospace">Welcome to the Read Message box </p>
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" 
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="Message_id" 
                    DataNavigateUrlFormatString="InViewInRead.aspx?Message_id={0}" 
                    Text="Read" />
            </Columns>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            SelectMethod="ShowBase_User_MessageRead" TypeName="ProductManager">
            <SelectParameters>
