<%@ Page Title="" Language="C#" MasterPageFile="~/FUNC/Done/MasterPageProp.master" AutoEventWireup="true" CodeFile="MUpdate_RH_Items.aspx.cs" Inherits="UpdateRH_Items" %>
        ...
        <tr>
            <td style="width: 139px" >
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT &quot;ITEM_NO&quot; FROM &quot;BASE_RH_ITEMS&quot;">
                </asp:SqlDataSource>
                <br />
            </td>
            <td >
