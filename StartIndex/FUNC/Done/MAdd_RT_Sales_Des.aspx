<%@ Page Title="" Language="C#" MasterPageFile="~/FUNC/Done/MasterPageProp.master" AutoEventWireup="true" CodeFile="MAdd_RT_Sales_Des.aspx.cs" Inherits="RTSalesDes" %>
...
&nbsp;</td>
        ...
        <tr>
            ...
            <td class="style3">
                <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" 
                    SelectMethod="ShowBase_RT_itemNameJoin" TypeName="ProductManager">
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" 
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="sales_id,sales_item_no" 
                    DataNavigateUrlFormatString="MAdd_RT_Sales_Des.aspx?sales_id={0}&amp;sales_item_no={1}" 
                    Text="Delete" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        DeleteMethod="Delete_BK_sales_des" SelectMethod="ShowBase_RTSales_des" 
