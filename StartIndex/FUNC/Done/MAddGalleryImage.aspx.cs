...
public partial class FUNC_Done_MAddGalleryImage : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Master.HeadingMessage = "Adding Image to Restaurant Gallery";
    }
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (FileUpload1.PostedFile.ContentType == "image/jpeg")
        {
            ...
            try
            {
                DataSet dataSet = ProductManager.ShowBase_imageGalVal();
                ...
                ProductManager.AddImageToGallery(val);

                FileUpload1.PostedFile.SaveAs("D://Uni/300 level/Semester 2/CS304(3)/Resturant chain System/1System/StartIndex/BaseRestaurant/images/gallery/" + filename);
