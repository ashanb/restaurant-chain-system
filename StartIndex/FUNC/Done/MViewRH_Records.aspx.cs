...
public partial class RHRecords : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
     ...
     Master.HeadingMessage = "Viewing Rest House Records";
     output.Text = "";
    ...
    {
        if (RTypeDropDownList.SelectedItem.ToString() == "Total Number of Rooms Allocated")
        {
            try
            {
                ...
                if (DateDropDownList.SelectedValue == "Last 7 days")
                {
                    ...
                    while (i < 7)
                    {
                        ...
                        DataSet ds = ProductManager.ShowBase_BillsPaid("RH", DateTime.Now.AddDays(-i).ToShortDateString());
                ...
                else if (DateDropDownList.SelectedValue == "Weekly")
                {
                    ...
                    while (i < 5)
                    {
                        ...
                        while (j < 7)
                        {
                            ...
                            DataSet ds = ProductManager.ShowBase_BillsPaid("RH", DateTime.Now.AddDays(-(j + (i * 7))).ToShortDateString());
                ...
                else if (DateDropDownList.SelectedValue == "Monthly")
                {
                    ...
                    while (i < 5)
                    {
                        ...
                        while (j < 30)
                        {
                            ...
                            DataSet ds = ProductManager.ShowBase_BillsPaid("RH", DateTime.Now.AddDays(-(j + (i * 30))).ToShortDateString());
                            count = count + ds.Tables["Base_salespaid"].Rows.Count;
                            j++;
                        }
