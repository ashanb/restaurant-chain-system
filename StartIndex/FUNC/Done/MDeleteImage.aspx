<%@ Page Title="" Language="C#" MasterPageFile="~/FUNC/Done/MasterPageProp.master" AutoEventWireup="true" CodeFile="MDeleteImage.aspx.cs" Inherits="FUNC_Done_MDeleteImage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" Runat="Server">
    ...
    <table border="strong" bgcolor="#D1A476">
        <tr >
            ...
            <td>
                <asp:TextBox ID="DeleteTextBox" runat="server" Height="32px" Width="316px"></asp:TextBox>
            </td>
            <td class="style2">
                &nbsp;</td>
        </tr>
