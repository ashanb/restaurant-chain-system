<%@ Page Title="" Language="C#" MasterPageFile="~/FUNC/Done/MasterPageProp.master" AutoEventWireup="true" CodeFile="InViewIninbox.aspx.cs" Inherits=" InInbox" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" Runat="Server">
    <div id="menu22">
        ...
        <div id="menu23">
             ...
             <ul>
               ...
               <li><a class="active" href="InViewIninbox.aspx">Inbox</a></li>
    ...
    <asp:Panel ID="Panel1" runat="server" BorderStyle="Groove">
        <table style="width: 100%;">
            <tr>
                <td colspan="3">
                  <p style="font-weight: bolder; color: #000000; font-size: large; font-family: 'Courier New', Courier, monospace">Welcome to the Inbox </p>
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" 
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="Message_id" 
                    DataNavigateUrlFormatString="InViewIninbox.aspx?Message_id={0}" 
                    Text="Read" />
            </Columns>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            SelectMethod="ShowBase_User_MessageInbox" TypeName="ProductManager">
            <SelectParameters>
