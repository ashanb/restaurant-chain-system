<%@ Page Title="" Language="C#" MasterPageFile="~/FUNC/Done/MasterPageProp.master" AutoEventWireup="true" CodeFile="MEdit_RT.aspx.cs" Inherits="ViewUsers" %>
        ...
        <tr>
            ...
            <td class="style3" colspan="3" >
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                    ...
                    UpdateMethod="update_Shenali_StocksRT">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="RT" Name="loc" Type="String" />
                    </SelectParameters>
                    <UpdateParameters>
