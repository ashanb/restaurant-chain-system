<%@ Page Title="" Language="C#" MasterPageFile="~/FUNC/Done/MasterPageProp.master" AutoEventWireup="true" CodeFile="MAdd_BK_Sales_Report.aspx.cs" Inherits="BKSalesReport" %>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="sales_id,sales_item_no" 
                            DataNavigateUrlFormatString="MAdd_BK_Sales_Report.aspx?sales_id={0}&amp;sales_item_no={1}" 
                            Text="Delete" />
             ...
             <tr>
                 ...
                 <td class="style5">
                     <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                         SelectMethod="ShowBase_BKSales_des" TypeName="ProductManager">
                         <SelectParameters>
